...
public class DockerignoreGenCommandTests
{
    ...
    public async Task ExecuteAsync_should_call_CreateEntryAsync_with_correct_parameters()
    {
        ...
        await _fileGenService
            ...
            .CreateEntryAsync(
                Arg.Any<ZipArchive>(),
                Arg.Is<string>(x => x == ".dockerignore"),
                Arg.Is<string>(x => x == DockerignoreContent.Value),
